...
async function seedDatabase() {
  console.log('🌱 Starting ultra-secure database seeding...\n');
  ...
  try {
    ...
    console.log(`  ✅ Usuario creado (ID: ${adminId})`);
    ...
    for (const estado of estados) {
      ...
      console.log(`  ✅ Estado: ${estado.nombre} (ID: ${result.insertId})`);
    }

    // ==================== 3. DELEGACIONES ====================
    console.log('\n🏛️  Creating delegaciones...');

    const delegaciones = [
      { nombre: 'Cuauhtémoc', estado: 'CDMX' },
      { nombre: 'Miguel Hidalgo', estado: 'CDMX' },
      { nombre: 'Guadalajara Centro', estado: 'JAL' },
      { nombre: 'San Pedro Garza García', estado: 'NL' }
    ];
    ...
    for (const deleg of delegaciones) {
      ...
      console.log(`  ✅ Delegación: ${deleg.nombre} (ID: ${result.insertId})`);
    }
    ...
    const colonias = [
      { nombre: 'Roma Norte', cp: '06700', delegacion: 'Cuauhtémoc' },
      { nombre: 'Condesa', cp: '06140', delegacion: 'Cuauhtémoc' },
      { nombre: 'Polanco', cp: '11560', delegacion: 'Miguel Hidalgo' },
      { nombre: 'Centro Histórico', cp: '44100', delegacion: 'Guadalajara Centro' }
    ];
    ...
    for (const colonia of colonias) {
      ...
      console.log(`  ✅ Colonia: ${colonia.nombre}, CP ${colonia.cp} (ID: ${result.insertId})`);
    }
    ...
    const familias = [
      { nombre: 'López García', direccion: 'Av. Álvaro Obregón 123', colonia: 'Roma Norte', notas: 'Familia muy activa en la comunidad' },
      { nombre: 'Martínez Hernández', direccion: 'Calle Tamaulipas 45', colonia: 'Condesa', notas: 'Contacto directo con presidente de colonia' },
      { nombre: 'González Pérez', direccion: 'Polanco Ave 789', colonia: 'Polanco', notas: 'Familia numerosa, requiere seguimiento' },
      { nombre: 'Rodríguez Sánchez', direccion: 'Paseo de la Reforma 1010', colonia: 'Polanco', notas: null },
      { nombre: 'Ramírez Torres', direccion: 'Calle Morelos 234', colonia: 'Centro Histórico', notas: 'Interesados en programas sociales' },
      ...
      { nombre: 'Mendoza Silva', direccion: 'Calle Mazatlán 345', colonia: 'Condesa', notas: null }
    ];
    ...
    for (const familia of familias) {
      ...
      console.log(`  ✅ Familia: ${familia.nombre} (ID: ${result.insertId})`);
    }
    ...
    const personas = [
      ...
      { nombre: 'Juan Carlos López García', curp: 'LOGJ800315HDFPRL01', telefono: '5555-1234', edad: '45', genero: 'M', fechaNac: '1980-03-15', rol: 'JEFE_FAMILIA', familia: 'López García', notas: 'Jefe de familia, comerciante' },
      { nombre: 'María Guadalupe García Pérez', curp: 'GAPM820420MDFRRR08', telefono: '5555-1234', edad: '42', genero: 'F', fechaNac: '1982-04-20', rol: 'ESPOSA', familia: 'López García', notas: null },
      { nombre: 'Carlos Alberto López García', curp: 'LOGC040815HDFPRL09', telefono: '5555-5678', edad: '20', genero: 'M', fechaNac: '2004-08-15', rol: 'HIJO', familia: 'López García', notas: 'Estudiante universitario' },
      { nombre: 'Ana Sofía López García', curp: 'LOGA071210MDFPRL02', telefono: null, edad: '17', genero: 'F', fechaNac: '2007-12-10', rol: 'HIJA', familia: 'López García', notas: null },

      // Familia Martínez Hernández
      { nombre: 'Roberto Martínez Hernández', curp: 'MAHR860522HDFRRB05', telefono: '5555-9876', edad: '38', genero: 'M', fechaNac: '1986-05-22', rol: 'JEFE_FAMILIA', familia: 'Martínez Hernández', notas: null },
      { nombre: 'Laura Hernández Díaz', curp: 'HEDL890715MDFRZR03', telefono: '5555-9876', edad: '35', genero: 'F', fechaNac: '1989-07-15', rol: 'ESPOSA', familia: 'Martínez Hernández', notas: 'Maestra de primaria' },
      { nombre: 'Diego Martínez Hernández', curp: 'MAHD120320HDFRG06', telefono: null, edad: '12', genero: 'M', fechaNac: '2012-03-20', rol: 'HIJO', familia: 'Martínez Hernández', notas: null },

      // Familia González Pérez
      { nombre: 'Patricia González Pérez', curp: 'GOPP720815MDFNRT04', telefono: '5555-4567', edad: '52', genero: 'F', fechaNac: '1972-08-15', rol: 'JEFE_FAMILIA', familia: 'González Pérez', notas: 'Madre soltera, empleada de gobierno' },
      { nombre: 'Sofía González Ramírez', curp: 'GORS991120MDFNMF07', telefono: '5555-4568', edad: '25', genero: 'F', fechaNac: '1999-11-20', rol: 'HIJA', familia: 'González Pérez', notas: null },

      // Familia Rodríguez Sánchez
      { nombre: 'Miguel Ángel Rodríguez Sánchez', curp: 'ROSM830910HDFDSN01', telefono: '5555-7890', edad: '41', genero: 'M', fechaNac: '1983-09-10', rol: 'JEFE_FAMILIA', familia: 'Rodríguez Sánchez', notas: null },
      { nombre: 'Elena Sánchez López', curp: 'SALE850225MDFSPL08', telefono: '5555-7890', edad: '39', genero: 'F', fechaNac: '1985-02-25', rol: 'ESPOSA', familia: 'Rodríguez Sánchez', notas: null },
      { nombre: 'Luis Miguel Rodríguez Sánchez', curp: 'ROSL090505HDFSLS03', telefono: null, edad: '15', genero: 'M', fechaNac: '2009-05-05', rol: 'HIJO', familia: 'Rodríguez Sánchez', notas: 'Estudiante de secundaria' },

      // Familia Ramírez Torres
      { nombre: 'José Ramírez Torres', curp: 'RATJ690618HDFMRS02', telefono: '5555-2345', edad: '55', genero: 'M', fechaNac: '1969-06-18', rol: 'JEFE_FAMILIA', familia: 'Ramírez Torres', notas: 'Jubilado, activista social' },
      { nombre: 'Carmen Torres Vega', curp: 'TOVC710822MDFRR09', telefono: '5555-2345', edad: '53', genero: 'F', fechaNac: '1971-08-22', rol: 'ESPOSA', familia: 'Ramírez Torres', notas: null },

      // Familia Flores Morales
      { nombre: 'Andrea Flores Morales', curp: 'FOMA950415MDFLRD04', telefono: '5555-6789', edad: '29', genero: 'F', fechaNac: '1995-04-15', rol: 'JEFE_FAMILIA', familia: 'Flores Morales', notas: 'Madre soltera, diseñadora gráfica' },
      ...
      { nombre: 'Mónica Silva Cortés', curp: 'SICM930515MDFLRT01', telefono: '5555-8901', edad: '31', genero: 'F', fechaNac: '1993-05-15', rol: 'ESPOSA', familia: 'Mendoza Silva', notas: null }
    ];
    ...
    for (const persona of personas) {
      ...
      const query = `INSERT INTO personas (${fields.join(', ')}) VALUES (${placeholders})`;

      await writePool.query(query, values);
      personasCount++;
    }

    console.log(`  ✅ ${personasCount} personas creadas (${votantesCount} pueden votar)`);
    ...
    console.log(`   - ${votantesCount} personas pueden votar (≥18 años)`);
    console.log('\n🔐 Todos los campos sensibles cifrados con 5 capas');
